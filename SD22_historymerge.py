...
sd22_df = pd.read_csv('~/Downloads/SD-22/sd22_eligible.csv', dtype={'full_phone_number': str})
...
sd22_df.to_csv('/Users/karthikbalasubramanian/Downloads/SD-22/sd22_history.csv', index=False)
